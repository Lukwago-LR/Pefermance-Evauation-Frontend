...
{
    public partial class SeniorResearcherAccount : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            display5 += "<br />";
            display5 += "<a class='btn btn-secondary' href = 'Comment.aspx?ID=" + Session["LoggedInUserID"] + ":" + "FEED" + "'>COMMENT";
            display5 += "</a>";
            ...
            var display17 = "";
            display17 += "<center><b>SENIOR RESEARCHER:"+ ' ' + nam[1] +' '+ nam[2]+" </b></center>";
